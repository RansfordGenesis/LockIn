...
Your task is to analyze the user's learning goal and generate intelligent, contextual follow-up questions that will help create a highly structured, practical 12-month learning plan.
...
{
  "detectedCategory": "backend|frontend|fullstack|ml-ai|data-engineer|data-scientist|devops|mobile|cloud|cybersecurity|qa|game-dev|blockchain|dsa|product|other",
  "categoryName": "Human-readable category name (e.g., 'Backend Development')",
  ...
  "questions": [
    {
      "id": "primary-tech",
      "question": "Clear, specific question about their primary technology choice",
      "type": "single",
...
5. DO NOT include "Other (specify)" option - provide comprehensive options instead
6. DO NOT ask about experience level (handled separately)
7. DO NOT ask about time commitment (handled separately)
8. Questions should flow naturally: Primary choice → Specialization → Supporting tools → Goals
9. Make options industry-relevant and up-to-date (2024-2025 technologies)
10. Each question's "reason" should be encouraging and explain the value
11. Provide 4-8 good options per question covering most common choices

Generate questions that will help create a comprehensive, practical, industry-aligned 12-month learning roadmap.`;
